...
if TristanaMenu.Combo.R:Value() then
	if CanUseSpell(myHero,_R) == READY and ValidTarget(target,GetCastRange(myHero,_R)) and GetCurrentHP(target) < CalcDamage(myHero, target, 0, 245 + 100*GetCastLevel(myHero,_R) + GetBonusAP(myHero)) then
